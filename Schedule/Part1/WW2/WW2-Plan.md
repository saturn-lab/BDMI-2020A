...
|   3       | Python练习1  ``cal_pi.py``    |  泰勒展开 实践    |     TAs     |    [1_Project](../../../Course-Projects/1_Project)     |


|时间段     |  内容    | 讲课 / 实践     |  分工  |备注       |
| :---      |   :----:    |   :----:    |    :----:    |       ---: |
|   1       | [Python-Numpy](Python-Nummpy.md)   |  讲课    |     WX     |    想一想，做一做      |
...
|时间段     |  内容    | 讲课 / 实践     |  分工  |备注       |
| :---      |   :----:    |   :----:    |    :----:    |       ---: |
|   1       | [课后作业1](../../Course-Projects/Course_Project_2/)    |  实验介绍与判题    |     ZY    |    想一想，做一做     |
